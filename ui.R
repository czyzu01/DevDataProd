...
#     )
    ...
    headerPanel("QCC visualisation demo"),
    sidebarPanel(
        helpText('By changing dates you can see how QCC charts are changing.'),
        dateInput("start_date", "Start date:", value="2012-07-01", min="2012-07-01", max="2014-08-03"),
        dateInput("cut_off_point", "Cut off point:", value="2014-07-01", min="2012-07-02", max="2014-08-04"),
        dateInput("finish_date", "Finish date:", value="2014-08-05", min="2012-07-03", max="2014-08-05")
    ),
    mainPanel(
